...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
  "$ROOT_DIR/tests/owner_reset_tests.cpp" -o "$BUILD_DIR/owner_reset_tests"
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -I"$ROOT_DIR/tests/owner_reset_fakes" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
  "$ROOT_DIR/logger/firmware/src/SignedOta.cpp" "$ROOT_DIR/tests/signed_ota_tests.cpp" \
...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DESP32 \
  ...
  -I"$ROOT_DIR/tests/fakes/ota" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
  "$ROOT_DIR/logger/firmware/src/SignedOtaEsp32.cpp" "$ROOT_DIR/tests/signed_ota_esp32_tests.cpp" \
  -o "$BUILD_DIR/signed_ota_esp32_tests"
"$BUILD_DIR/signed_ota_esp32_tests"

/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -pthread \
  -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" "$ROOT_DIR/tests/https_exchange_tests.cpp" \
...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror \
  ...
  "$ROOT_DIR/logger/firmware/src/Logic.cpp" \
  "$ROOT_DIR/logger/firmware/src/ProvisioningPolicy.cpp" \
...
if [ -d "$JSON_INCLUDE" ]; then
  /usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DESP32 -DARDUINOJSON_ENABLE_ARDUINO_STRING=1 \
    -I"$ROOT_DIR/tests/provisioning_fakes" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" -I"$JSON_INCLUDE" \
    "$ROOT_DIR/tests/provisioning_transition_tests.cpp" "$ROOT_DIR/logger/firmware/src/DeviceProvisioning.cpp" "$ROOT_DIR/logger/firmware/src/ProvisioningPolicy.cpp" \
  ...
  /usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DAPEXI_AUTH_HOST_TEST -DARDUINOJSON_ENABLE_ARDUINO_STRING=1 \
    -I"$ROOT_DIR/tests/auth_fakes" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" -I"$JSON_INCLUDE" \
    "$ROOT_DIR/tests/logger_authorization_tests.cpp" "$ROOT_DIR/logger/firmware/src/LoggerAuthorization.cpp" -o "$BUILD_DIR/logger_authorization_tests"
  "$BUILD_DIR/logger_authorization_tests"
  /usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DTEST_UPLOAD_JSON -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" -I"$JSON_INCLUDE" \
    "$ROOT_DIR/tests/upload_evidence_tests.cpp" -o "$BUILD_DIR/upload_evidence_json_tests"
  "$BUILD_DIR/upload_evidence_json_tests"
  /usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DTEST_GAUGE_JSON -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" -I"$JSON_INCLUDE" \
    "$ROOT_DIR/tests/dash_gauge_tests.cpp" -o "$BUILD_DIR/dash_gauge_tests"
  "$BUILD_DIR/dash_gauge_tests"
else
...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DAPEXI_HOST_TEST \
  -I"$ROOT_DIR/tests/fakes" \
  -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
  "$ROOT_DIR/logger/firmware/src/AppBearerRotation.cpp" \
...
/usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -DESP32 \
  -I"$ROOT_DIR/tests/fakes" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
  "$ROOT_DIR/logger/firmware/src/AppBearerRotation.cpp" \
  "$ROOT_DIR/tests/app_bearer_rotation_tests.cpp" \
...
for target in ESP32 ESP8266; do
  /usr/bin/c++ -std=c++17 -Wall -Wextra -Werror -D"$target" \
    -I"$ROOT_DIR/tests/fakes" -I"$ROOT_DIR/logger/firmware/include" -I"$ROOT_DIR/dash/firmware/include" -I"$ROOT_DIR/shared/protocols" -I"$ROOT_DIR/shared/libraries" \
    "$ROOT_DIR/logger/firmware/src/StatusDiagnostics.cpp" "$ROOT_DIR/tests/status_diagnostics_tests.cpp" \
