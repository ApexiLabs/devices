...
int main() {
  ...
  static_assert(60*60+86*86<106*106,"Top caption clears inner arc");
  static_assert(58*58+88*88<106*106,"Bottom detail clears inner arc");
  static_assert(DashDisplayLayout::labelWidth==120 && DashDisplayLayout::detailWidth==116);
  static_assert(DashDisplayLayout::valueWidth(2)==160 && DashDisplayLayout::valueWidth(1)==180);
